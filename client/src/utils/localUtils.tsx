...
export const translations: Translations = {
  ...
  "es-ES": {
    ...
    addAIAgent: "Agregar Agente IA",
    aiAgentParticipant: "Participante de Agente IA",
    aiAgentIdentity: "Nombre del Agente",
  ...
  "fr-FR": {
    ...
    addAIAgent: "Ajouter Agent IA",
    aiAgentParticipant: "Participant Agent IA",
    aiAgentIdentity: "Nom de l'Agent",
